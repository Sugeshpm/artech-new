          ...
          success:function(response){
            ...
            if(data.output == 1){
                if(data.form_type == 1){
                    ...
                    window.dataLayer = window.dataLayer || [];
                     window.dataLayer.push({
                        'event': 'Kottayambrochuredownload'
                     });
                    //alert(project);
                    if(project == 1){
                        window.location.href = data.url+'/cygnus.pdf';
                    }else if(project == 2){
                        window.location.href = data.url+'/blueberry.pdf';
                    }
                }
                }else{
